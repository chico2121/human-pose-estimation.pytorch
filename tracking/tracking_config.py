...
# # human detector
# config.HD = edict()
# config.HD.IMAGE_SIZE = [1333, 800]
#
# # pose estimator
# config.PE = edict()
# config.PE.IMAGE_SIZE = [288, 384]

# tracking
config.TRACKING = edict()
config.TRACKING.DETECTION_CONFIG_PATH = '/root/mmdetection/configs/dcn/faster_rcnn_dconv_c3-c5_x101_32x4d_fpn_1x_test_posetrack.py'
config.TRACKING.DETECTION_MODEL_PATH = '/root/mmdetection/work_dirs/faster_rcnn_dconv_c3-c5_x101_32x4d_fpn_1x/latest.pth'
config.TRACKING.POSE_ESTIMATION_CONFIG_PATH = 'experiments/posetrack/384x288_d256x3_adam_lr1e-3.yaml'
config.TRACKING.POSE_ESTIMATION_MODEL_PATH = 'output/posetrack/pose_resnet_152/384x288_d256x3_adam_lr1e-3/model_best.pth.tar'
# config.TRACKING.ROOT = 'data/posetrack/'
config.TRACKING.ROOT = '../data/posetrack/'
config.TRACKING.DATASET = 'images/val/'
config.TRACKING.VIDEO_FILE_NAME = '000522_mpii_test'
config.TRACKING.QUEUE_LEN = 20
config.TRACKING.SIM_THRE = 0.1
config.TRACKING.FLOW_DATASET = 'flow/val/'
config.TRACKING.SAVE_IMAGE_PATH = 'tracking_result/imgs/'
# config.TRACKING.BBOX_THRE = 0.5
